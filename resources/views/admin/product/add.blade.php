            ...
            <div class="col-lg-10" style="padding-bottom:120px">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                    	...
                    	<input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Nhập tên sản phẩm">
                        <span class="text-danger">{{ $errors->first('name') }}</span>
                    </div>
                    <div class="form-group">
                    	<label>Giá sản phẩm</label>
                    	<input type="number" name="price" value="{{ old('price') }}" class="form-control" placeholder="Nhập giá sản phẩm">
                        <span class="text-danger">{{ $errors->first('price') }}</span>
                    </div>
                    <div class="form-group">
                    	<label>Nội dung sản phẩm</label>
                    	<textarea class="form-control editor" name="content" id="editor1" placeholder="Nhập nội dung sản phẩm" rows="10">{{ old('content') }}</textarea>
                        <span class="text-danger">{{ $errors->first('content') }}</span>
                    </div>
                    <div class="form-group">
                        <label>Mã giảm giá</label>
                        <input type="text" name="sale" value="{{ old('sale') }}" class="form-control" placeholder="Nhập mã giảm giá">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="number" value="{{ old('number') }}" class="form-control" placeholder="Nhập số lượng sản phẩm">
                        <span class="text-danger">{{ $errors->first('number') }}</span>
                    </div>
                    <div class="form-group">
                    	<label style="display: block;">Trạng thái sản phẩm</label>
                    	<label class="radio-inline"><input type="radio" name="status" value="0" checked>Không kích hoạt</label>
